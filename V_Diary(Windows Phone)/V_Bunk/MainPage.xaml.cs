    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void constructor()
        {
            try
            {
                ...
                object timetableJson = localSettings.Values["timeTable"];
                object allSubjectsJson = localSettings.Values["All subjects"];
                if(timetableJson!=null && allSubjectsJson != null)
                {
                    myClass.timeTable = JsonConvert.DeserializeObject<ObservableCollection<ObservableCollection<timeTableCell>>>(timetableJson.ToString());
                    myClass.attCol = JsonConvert.DeserializeObject<ObservableCollection<Subject>>(allSubjectsJson.ToString());
                }*/
